...
<html lang="en" >
   ...
   <head>
      <base href="../../../">
      <meta charset="utf-8"/>
      <title>Login | {{ config('app.name', 'Jobs') }}</title>
      ...
      <div class="d-flex flex-column flex-root">
         ...
         <div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
            ...
            <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
               ...
               <div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center" style="background-image: url(images/BT-home-reserch-new.png)"></div>
               <!--end::Aside Bottom-->
            </div>
            <!--begin::Aside-->
            <!--begin::Content-->
                  ...
                  <div class="login-form login-signin">
                     ...
                     <form class="form" novalidate="novalidate" id="" method="POST" action="{{ route('admin.login') }}">
                        ...
                        <div class="pb-13 pt-lg-0 pt-5">
                           <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Welcome to {{ config('app.name', 'GSBTM') }}</h3>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="text" name="login" autocomplete="off" required/>
                        </div>
                        <!--end::Form group-->
                        <!--begin::Form group-->
                        <div class="form-group">
